//Mouse action - 1.Hover, 2.Double click, 3.Drag and Drop, 4.Right click
...
test("Handling Mouse actions", async ({page})=>{
    ...
    //1.Hover 
    await page.locator('[class="dropbtn"]').scrollIntoViewIfNeeded() //Point me
    ...
    // await page.locator('[id="field1"]').clear()          //Field1
    // await page.locator('[id="field1"]').fill('prabubodi')
    // await page.locator('[ondblclick="myFunction1()"]').dblclick()    //Copytext
    // await page.waitForTimeout(2000)
    ...
    // let yamu = await page.locator('[id="droppable"]')    

    // await gayu.dragTo(yamu)
    // await page.waitForTimeout(2000)
    // await page.reload()
